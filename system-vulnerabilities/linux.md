...
#### 1058. [Ubuntu] USN-8234-1: Mako vulnerability
...
#### 1059. [Ubuntu] USN-8233-1: nghttp2 vulnerability
...
#### 1060. [Ubuntu] USN-8232-1: Django vulnerabilities
...
#### 1061. [Ubuntu] USN-8229-1: sed vulnerability
...
#### 1062. [Ubuntu] USN-8227-1: curl vulnerabilities
...
#### 1063. CVE-2026-6420 - keylime: Keylime: Security bypass due to hardcoded TPM quote nonce
...
#### 1064. CVE-2026-44405 - paramiko: Paramiko: Data integrity could be compromised due to SHA-1 algorithm use
...
#### 1065. CVE-2026-28780 - Apache HTTP Server: mod_proxy_ajp: Apache HTTP Server mod_proxy_ajp: Arbitrary…
...
#### 1066. CVE-2026-34002 - xorg: xwayland: X.Org X server: Information disclosure or Denial of Service via…
...
#### 1067. CVE-2026-34000 - xwayland: xorg: X.Org X server: Information disclosure and denial of service via…
...
#### 1068. CVE-2026-43072 - kernel: drm/vc4: platform_get_irq_byname() returns an int
...
#### 1069. CVE-2026-43071 - kernel: dcache: Limit the minimal number of bucket to two
...
#### 1070. CVE-2026-43061 - kernel: serial: 8250: Fix TX deadlock when using DMA
...
#### 1071. CVE-2026-43070 - kernel: bpf: Reset register ID for BPF_END value tracking
...
#### 1072. CVE-2026-43073 - kernel: x86-64: rename misleadingly named '__copy_user_nocache()' function
...
#### 1073. CVE-2026-43064 - kernel: dmaengine: idxd: Fix not releasing workqueue on .release()
...
#### 1074. CVE-2026-43063 - kernel: xfs: don't irele after failing to iget in xfs_attri_recover_work
...
#### 1075. CVE-2026-43059 - kernel: Bluetooth: MGMT: Fix list corruption and UAF in command complete handlers
...
#### 1076. CVE-2026-43066 - kernel: ext4: fix iloc.bh leak in ext4_fc_replay_inode() error paths
...
#### 1077. CVE-2026-43060 - kernel: netfilter: nft_ct: drop pending enqueued packets on removal
...
#### 1078. CVE-2026-43068 - kernel: ext4: avoid allocate block from corrupted group in ext4_mb_find_by_goal()
...
#### 1079. CVE-2026-43069 - kernel: Bluetooth: hci_ll: Fix firmware leak on error path
...
#### 1080. CVE-2026-43067 - kernel: ext4: handle wraparound when searching for blocks for indirect mapped…
...
#### 1081. CVE-2026-6321 - fast-uri: fast-uri: Path traversal vulnerability allows bypass of security policies
...
#### 1082. CVE-2026-42027 - Apache OpenNLP: Apache OpenNLP: Arbitrary Class Loading via Model Manifest
...
#### 1083. [Ubuntu] USN-8237-1: WebKitGTK vulnerabilities
...
#### 1084. [Ubuntu] USN-8231-1: Dynaconf vulnerability
...
**严重程度 / Severity**: MEDIUM | CVSS: 5.3
**受影响产品 / Affected Products**: debian:debian_linux, glyphandcog:xpdf
...
**严重程度 / Severity**: HIGH | CVSS: 7.5
**受影响产品 / Affected Products**: debian:debian_linux, prosody:prosody
...
**严重程度 / Severity**: CRITICAL | CVSS: 9.8
**受影响产品 / Affected Products**: debian:devscripts, canonical:ubuntu_linux
...
**严重程度 / Severity**: HIGH | CVSS: 7.0
**受影响产品 / Affected Products**: debian:debian_linux, debian:tmpreaper
...
**严重程度 / Severity**: CRITICAL | CVSS: 9.8
**受影响产品 / Affected Products**: rdflib_project:rdflib, debian:debian_linux, canonical:ubuntu_linux
...
**严重程度 / Severity**: HIGH | CVSS: 7.8
**受影响产品 / Affected Products**: debian:debian-lan-config, debian:debian_linux, canonical:ubuntu_linux, skolelinux:debian-edu-config
...
**严重程度 / Severity**: HIGH | CVSS: 7.8
**受影响产品 / Affected Products**: debian:debian_linux, debian:x11-common
...
**严重程度 / Severity**: MEDIUM | CVSS: 4.3
**受影响产品 / Affected Products**: debian:debian_linux, sympa:sympa
...
**严重程度 / Severity**: HIGH | CVSS: 7.8
**受影响产品 / Affected Products**: debian:debian_linux, avahi:avahi
...
**严重程度 / Severity**: HIGH | CVSS: 7.8
**受影响产品 / Affected Products**: debian:debian_linux, debian:shadow
...
**严重程度 / Severity**: HIGH | CVSS: 8.8
**受影响产品 / Affected Products**: freedesktop:xdg-utils, debian:debian_linux
...
**受影响产品 / Affected Products**: siemens:siveillance_control, siemens:operation_scheduler, siemens:siveillance_control_pro, siemens:desigo_cc, debian:debian_linux
...
**严重程度 / Severity**: MEDIUM | CVSS: 6.5
**受影响产品 / Affected Products**: debian:debian_linux, eduvpn:vpn-user-portal, fedoraproject:fedora
...
**严重程度 / Severity**: CRITICAL | CVSS: 9.8
**受影响产品 / Affected Products**: skolelinux:debian-edu-config, debian:debian_linux
...
#### 1190. [Ubuntu] USN-8245-1: Linux kernel vulnerabilities
...
#### 1191. [Ubuntu] USN-8244-1: Linux kernel vulnerabilities
...
#### 1192. [Ubuntu] USN-8243-1: Linux kernel (Azure) vulnerabilities
...
#### 1193. [Ubuntu] USN-8235-1: ITK vulnerabilities
...
#### 1194. [Ubuntu] USN-8241-1: Coin3D vulnerabilities
...
**严重程度 / Severity**: N/A | CVSS: 6.0
**受影响产品 / Affected Products**: redhat:enterprise_linux_desktop, openpegasus:openpegasus_wbem, redhat:enterprise_linux
...
**严重程度 / Severity**: N/A | CVSS: 6.0
**受影响产品 / Affected Products**: redhat:_dogtag_certificate_system, redhat:certificate_system
...
**严重程度 / Severity**: N/A | CVSS: 5.0
**受影响产品 / Affected Products**: redhat:enterprise_linux, net-snmp:net-snmp
...
**严重程度 / Severity**: N/A | CVSS: 6.8
**受影响产品 / Affected Products**: redhat:enterprise_linux, gnome:gdm
...
**严重程度 / Severity**: HIGH | CVSS: 7.5
**受影响产品 / Affected Products**: redhat:enterprise_linux_workstation, linux:linux_kernel, redhat:virtualization, redhat:enterprise_linux_eus, redhat:enterprise_linux_desktop
...
**严重程度 / Severity**: N/A | CVSS: 4.9
**受影响产品 / Affected Products**: linux:linux_kernel, debian:debian_linux, redhat:enterprise_linux
...
**严重程度 / Severity**: HIGH | CVSS: 8.8
**受影响产品 / Affected Products**: redhat:jboss_enterprise_application_platform, netapp:oncommand_unified_manager, netapp:oncommand_insight, netapp:oncommand_balance, redhat:enterprise_linux
...
**严重程度 / Severity**: N/A | CVSS: 4.3
**受影响产品 / Affected Products**: redhat:enterprise_linux, redhat:enterprise_linux_desktop, apache:tomcat, redhat:desktop_workstation
...
**严重程度 / Severity**: N/A | CVSS: 6.6
**受影响产品 / Affected Products**: redhat:qspice, redhat:enterprise_virtualization
...
**严重程度 / Severity**: N/A | CVSS: 6.6
**受影响产品 / Affected Products**: redhat:enterprise_virtualization, redhat:kvm
